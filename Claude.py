...
def train_setfit_model(train_data, eval_data, num_epochs=3):
    ...
    trainer = SetFitTrainer(
        ...
        num_iterations=num_epochs,  # Use num_iterations instead of num_epochs
        batch_size=16,
        metric="accuracy",
    )
...
def main(file_path, feature_columns, num_epochs=3):
    ...
    train_data, test_data = load_and_preprocess_data(file_path, feature_columns)
    ...
    model = train_setfit_model(train_data, eval_data, num_epochs)
